...
export default function Header() {
    ...
    const showNotificaction = useAppStore((state) => state.showNotificaction)
                ...
                {isHome && (
                    ...
                    >
                        ...
                        <input 
                            ...
                            className=" cursor-pointer bg-orange-800 hover:bg-orange-900 text-white font-extrabold w-full p-2 rounded-lg uppercase transition-colors"
                        />
                    </form>
                )}
            </div>
